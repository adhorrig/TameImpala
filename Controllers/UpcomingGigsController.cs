...
namespace TameImpala.Controllers
{
    public class UpcomingGigsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UpcomingGigID,Location,Price,Date,Description,Title,UserID")] UpcomingGig upcomingGig)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UpcomingGigID,Location,Price,Date,Description,Title,UserID")] UpcomingGig upcomingGig)
        {
            if (ModelState.IsValid)
            {
